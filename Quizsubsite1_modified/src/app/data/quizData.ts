...
export const quizQuestions: Question[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { key: "C", text: "C. 4 Bước - Tạo đơn xin nghỉ - CBCNV gửi giấy tờ về C&B phụ trách - C&B lập danh sách đề nghị giải quyết cho cơ quan BHXH - Cơ quan BHXH phê duyệt hồ sơ" },
